...
import {
    ...
    ProductPriceVariantListQueryDocument,
...
export class PriceVariantListComponent
    extends TypedBaseListComponent<typeof ProductPriceVariantListQueryDocument, 'items'>
    implements OnInit
{
    pendingSearchIndexUpdates = 0;
    readonly customFields = this.getCustomFieldConfig('Product');
    readonly filters = this.createFilterCollection().addIdFilter();
    // .addDateFilters()
    // .addFilters([
    //     {
    //         name: 'enabled',
    ...
    //     super();
    //     this.configure({
    //         document: ProductPriceVariantListQueryDocument,
